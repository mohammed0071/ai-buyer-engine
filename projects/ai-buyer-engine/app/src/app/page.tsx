      ...
      <section className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-zinc-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            AI Buyer Engine monitors X/Twitter for real-time buying signals, warms up prospects with intelligent engagement, and books qualified meetings — all on autopilot.
          </p>
            ...
            {[
              {
                ...
                description: 'Monitor X/Twitter for buyer intent signals — pain points, competitor engagement, buying language, and more.',
                color: 'from-red-500 to-orange-500',
              },
              {
                icon: MessageSquare,
                title: 'AI Outreach',
                description: 'Warm up prospects with intelligent engagement, then send personalized DMs that feel genuinely human.',
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { name: 'Growth', price: '$399', desc: '2,000 prospects · 1,000 AI messages', popular: true, features: ['Everything in Starter', '3 connected accounts', '+ Calendly integration', 'Priority support'] },
