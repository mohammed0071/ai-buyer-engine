    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400">Start detecting buyers and booking meetings</p>
          {!isSupabaseReady && (
            <p className="text-xs text-amber-400 mt-2 px-3 py-1 bg-amber-400/10 rounded-full inline-block">Demo Mode</p>
          )}
        </div>
        ...
        <div className="space-y-4">
          <Button
            variant="outline"
            className="w-full border-zinc-700 bg-zinc-900 hover:bg-zinc-800 text-white h-11"
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-500 hover:to-violet-500 text-white h-11"
              disabled={loading}
            >
